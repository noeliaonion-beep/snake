...
public class Panel {
  ...
  private int colcabeza = 0;
  private int filacabeza = 0;
    ...
    public boolean perder(){
        ...
        if (colcabeza == mapa[0].length+1 || colcabeza == -1 || filacabeza == mapa.length+1 || filacabeza == -1){
            System.out.println("---------------------");
            System.out.println("-    Has perdido    -");
            System.out.println("---------------------");
        } else if (colcabeza == -2 && filacabeza == -2){
